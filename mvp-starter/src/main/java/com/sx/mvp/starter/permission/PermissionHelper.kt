package com.sx.mvp.starter.permission
...
import com.sx.mvp.starter.widget.PermissionDialog
...
object PermissionHelper {
                ...
                .subscribe {
                    if (it.granted) {
                        ...
                        showPermissionDialog(
                            activity, permission, "为了保证您正常使用此功能，需要获取相应权限，请允许。",
                            "去允许", true, requestSuccess
                        )
                    } else {
                        showPermissionDialog(
                            activity, permission, "未取得您的相应权限，此功能无法使用。请前往应用权限设置打开权限。",
    ...
    private fun showPermissionDialog(
        activity: FragmentActivity, permission: String, content: String, rightText: String,
        ...
        PermissionDialog.newBuilder()
            ...
            ?.setOnConfirmClickListener {
                if (showPermission) {
                    requestPermission(activity, permission, requestSuccess)
                } else {
